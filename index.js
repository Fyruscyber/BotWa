...
const telegram = 'Males Nyari'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtu.be/affmdx7mskM';
//const grupch1 = 'https://chat.whatsapp.com/JukBLA01STa1pl4j0vc3Ia'; 
//const grupch2 = 'https://chat.whatsapp.com/KvnrobWpHgXEKqYwzQMTTi' ; 
const
{
   WAConnection,
   MessageType,
...
{
conn.sendMessage(id, tambahan.Kenal Kah? ,MessageType.text);
}
else if (text == 'P')
{
conn.sendMessage(id, tambahan.Dilarang P Utamakan Salam ,MessageType.text);
}
else if (text == 'Test')
{
  conn.sendMessage(id, tambahan.Gk Jelas, MessageType.text);
}
else if (text == 'HAI')
{
conn.sendMessage(id, tambahan.Hai Juga ,MessageType.text);
}
else if (text == 'ASSALAMUALAIKUM')
{
conn.sendMessage(id, tambahan.Waalaikumsalam ,MessageType.text);
}
else if (text == 'BRO')
{
conn.sendMessage(id, tambahan.Apa? ,MessageType.text);
}
else if (text == 'BOT')
{
  conn.sendMessage(id, tambahan.Ya Ada Apa Kak?, MessageType.text);
}
// Fitur
